...
def unite_categories(categories_list):
    ...
    for categories in categories_list:
        old_category_id_to_new_ihavebadfantasy = dict()
        for category in categories:
            old_category_id_to_new_ihavebadfantasy[category['id']] = category_name_to_new_id[category['name']]
        old_category_id_to_new.append(old_category_id_to_new_ihavebadfantasy)
...
def unite_images(images_list):
    ...
    for images in images_list:
        old_image_id_to_new_ihavebadfantasy = dict()
        for image in images:
            old_image_id_to_new_ihavebadfantasy[image['id']] = image_name_to_new_id[image['file_name']]
        old_image_id_to_new.append(old_image_id_to_new_ihavebadfantasy)
